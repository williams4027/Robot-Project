...
variable_encoder0_low_threshold:		FDB	50
variable_encoder0_high_threshold:		FDB	200

* tick and velocity counts
variable_encoder0_counts:			FDB	0
variable_encoder0_velocity:			FDB	0
...
* reset encoder variables
	...
	STD	variable_encoder0_velocity
	STD	last_counts
...
* if zero, look for rising edge
	BNE	test_falling
	CMPA	variable_encoder0_high_threshold+1
	BLO	encdr_done
* got it! increment
got_click:
	...
	BRA	encdr_done
test_falling:
	CMPA	variable_encoder0_low_threshold+1
	BLO	got_click
