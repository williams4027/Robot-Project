...
variable_encoder5_low_threshold:		FDB	50
variable_encoder5_high_threshold:		FDB	200

* tick and velocity counts
variable_encoder5_counts:			FDB	0
variable_encoder5_velocity:			FDB	0
...
* reset encoder variables
	LDD	#0
	STAA	encoder_state
	STD	variable_encoder5_counts
	STD	variable_encoder5_velocity
	STD	last_counts
...
* if zero, look for rising edge
	BNE	test_falling
	CMPA	variable_encoder5_high_threshold+1
	BLO	encdr_done
* got it! increment
got_click:
	LDY	variable_encoder5_counts
	INY
	STY	variable_encoder5_counts
	LDAA	encoder_state
	EORA	#$FF
	STAA	encoder_state
	...
	BRA	encdr_done
test_falling:
	CMPA	variable_encoder5_low_threshold+1
	BLO	got_click
